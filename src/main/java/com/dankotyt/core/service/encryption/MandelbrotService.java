...
/**
 * Сервис генерации множества Мандельброта.
 *
 * <p>Генерирует изображения фрактала с использованием многопоточной обработки
 * и проверяет пригодность фрактала для шифрования на основе распределения цветов.</p>
 *
 * @author dankotyt
 * @since 1.1.0
 */
